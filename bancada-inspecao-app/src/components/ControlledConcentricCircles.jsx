...
export default function ControlledConcentricCircles({
  ...
  // const radiiArr = initialRadii;
  const radiiArr = Array.isArray(initialRadii) 
  ? initialRadii.map(r=> typeof r === 'object' ? r.value : r)
  : [230, 180, 150, 130];
    ...
    <div className="p-4">
      <svg width={size} height={size}>
        ...
        {layers.map((layer, i) => (
          ...
          {/* Seta */}
          <path
            d={`M ${center + maxRadius + 25} ${center} L ${center + maxRadius+10} ${center}`}
            stroke="transparent"
            strokeWidth="2"
        ...
        <defs>
          <marker
            ...
            orient="auto"
          >
            <path d="M10,3.5 L0,0 L0,7 Z" fill="blue" />
          </marker>
        </defs>
